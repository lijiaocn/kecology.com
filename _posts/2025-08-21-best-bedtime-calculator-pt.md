---
layout: page
title: "Calculadora da Hora de Dormir: A que horas preciso ir para a cama para me sentir revigorado?"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: pt
permalink: /pt/tool/best-bedtime-calculator
description: "Encontre a melhor hora para ir dormir com base em ciclos de sono de 90 minutos. Pode ajudá-lo a acordar sentindo-se revigorado e enérgico."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container">
    <h1>Calculadora da Hora de Dormir</h1>
    <p>Defina a sua hora de acordar para ver a que horas deve ir dormir.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">Atalhos: <kbd>↑</kbd> <kbd>↓</kbd> para ajustar, e <kbd>←</kbd> <kbd>→</kbd> para alternar</p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title">Para acordar revigorado às <span id="wake-up-time"></span>, tente adormecer a uma destas horas: <small style="font-weight: normal;">(Inclui 15 minutos para adormecer e ciclos de sono de 90 minutos)</small></h3>
        ...
        <div style="background-color: #1c2b3a; border-left: 5px solid #00c7b4; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: left;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> Conselho da British Heart Foundation: <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(leia mais)</a></p>
          <ul style="margin: 0; padding-left: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Durma entre as <strong>22h e as 23h</strong> para um coração mais saudável.
            </li>
            <li style="padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              A maioria dos adultos deve ter como objetivo <strong>7 a 9 horas</strong> de sono por noite.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>Ir para a cama agora?</h3>
        <a href="/pt/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">Experimente a nossa Calculadora da Hora de Acordar</a>
    </div>
</div>
...
<script>
    ...
    function createScroller(containerId, items, prevScrollerId, nextScrollerId) {
        ...
        container.addEventListener('wheel', e => {
            ...
            realTranslateY -= e.deltaY * 0.5; // Ajustar a sensibilidade
        ...
        // Suporte para teclado e clique
        container.tabIndex = 0; // Tornar focável
        container.style.outline = 'none'; // Remover contorno padrão

        container.addEventListener('focus', () => {
            selection.style.borderColor = '#ffc107'; // Realçar ao focar
        });
        container.addEventListener('blur', () => {
            selection.style.borderColor = '#00c7b4'; // Reverter ao desfocar
        });
    ...
    function calculateBedtimes() {
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} de sono)`;
