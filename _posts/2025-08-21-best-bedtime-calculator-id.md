---
layout: page
title: "Kalkulator Waktu Tidur: Jam Berapa Saya Harus Tidur Agar Merasa Segar?"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: id
permalink: /id/tool/best-bedtime-calculator
description: "Temukan waktu terbaik untuk tidur berdasarkan siklus tidur 90 menit. Ini dapat membantu Anda bangun dengan perasaan segar dan berenergi."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container">
    <h1>Kalkulator Waktu Tidur</h1>
    <p>Atur waktu bangun Anda untuk melihat kapan Anda harus tidur.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">Pintasan: <kbd>↑</kbd> <kbd>↓</kbd> untuk menyesuaikan, dan <kbd>←</kbd> <kbd>→</kbd> untuk beralih</p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title">Agar bangun segar pada pukul <span id="wake-up-time"></span>, cobalah tidur pada salah satu waktu berikut: <small style="font-weight: normal;">(Termasuk 15 menit untuk tertidur & siklus tidur 90 menit)</small></h3>
        ...
        <div style="background-color: #1c2b3a; border-left: 5px solid #00c7b4; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: left;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> Saran British Heart Foundation: <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(baca lebih lanjut)</a></p>
          <ul style="margin: 0; padding-left: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Tidur antara <strong>pukul 10-11 malam</strong> untuk jantung yang lebih sehat.
            </li>
            <li style="padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Kebanyakan orang dewasa harus menargetkan <strong>7 hingga 9 jam</strong> tidur per malam.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>Tidur sekarang?</h3>
        <a href="/id/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">Coba Kalkulator Waktu Bangun Kami</a>
    </div>
</div>
...
<script>
    ...
    function createScroller(containerId, items, prevScrollerId, nextScrollerId) {
        ...
        container.addEventListener('wheel', e => {
            ...
            realTranslateY -= e.deltaY * 0.5; // Sesuaikan sensitivitas
        ...
        // Dukungan Keyboard dan Klik
        container.tabIndex = 0; // Buat dapat difokuskan
        container.style.outline = 'none'; // Hapus garis luar default

        container.addEventListener('focus', () => {
            selection.style.borderColor = '#ffc107'; // Sorot saat difokuskan
        });
        container.addEventListener('blur', () => {
            selection.style.borderColor = '#00c7b4'; // Kembalikan saat blur
        });
    ...
    function calculateBedtimes() {
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} tidur)`;
