---
layout: page
title: "Calcolatore dell'ora di andare a letto: A che ora devo andare a letto per sentirmi riposato?"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: it
permalink: /it/tool/best-bedtime-calculator
description: "Trova l'ora migliore per andare a dormire basandoti su cicli di sonno di 90 minuti. Può aiutarti a svegliarti sentendoti riposato ed energico."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container">
    <h1>Calcolatore dell'ora di andare a letto</h1>
    <p>Imposta l'ora in cui vuoi svegliarti per vedere quando dovresti andare a dormire.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">Scorciatoie: <kbd>↑</kbd> <kbd>↓</kbd> per regolare, e <kbd>←</kbd> <kbd>→</kbd> per cambiare</p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title">Per svegliarti riposato alle <span id="wake-up-time"></span>, prova ad addormentarti in uno di questi orari: <small style="font-weight: normal;">(Include 15 minuti per addormentarsi e cicli di sonno di 90 minuti)</small></h3>
        ...
        <div style="background-color: #1c2b3a; border-left: 5px solid #00c7b4; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: left;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> Consiglio della British Heart Foundation: <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(leggi di più)</a></p>
          <ul style="margin: 0; padding-left: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Dormi tra le <strong>22:00 e le 23:00</strong> per un cuore più sano.
            </li>
            <li style="padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              La maggior parte degli adulti dovrebbe mirare a <strong>7-9 ore</strong> di sonno per notte.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>Andare a letto ora?</h3>
        <a href="/it/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">Prova il nostro Calcolatore dell'ora di sveglia</a>
    </div>
</div>
...
<script>
    ...
    function createScroller(containerId, items, prevScrollerId, nextScrollerId) {
        ...
        container.addEventListener('wheel', e => {
            ...
            realTranslateY -= e.deltaY * 0.5; // Regola la sensibilità
        ...
        // Supporto per tastiera e clic
        container.tabIndex = 0; // Rendi focalizzabile
        container.style.outline = 'none'; // Rimuovi il contorno predefinito

        container.addEventListener('focus', () => {
            selection.style.borderColor = '#ffc107'; // Evidenzia quando in focus
        });
        container.addEventListener('blur', () => {
            selection.style.borderColor = '#00c7b4'; // Ripristina quando perde il focus
        });
    ...
    function calculateBedtimes() {
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} di sonno)`;
