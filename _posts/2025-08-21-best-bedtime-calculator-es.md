---
layout: page
title: "Calculadora de hora de dormir: ¿A qué hora debo acostarme para sentirme renovado?"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: es
permalink: /es/tool/best-bedtime-calculator
description: "Encuentra la mejor hora para ir a dormir basándose en ciclos de sueño de 90 minutos. Puede ayudarte a despertar sintiéndote renovado y con energía."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container">
    <h1>Calculadora de hora de dormir</h1>
    <p>Establece tu hora de despertar para ver a qué hora deberías irte a dormir.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">Atajos: <kbd>↑</kbd> <kbd>↓</kbd> para ajustar, y <kbd>←</kbd> <kbd>→</kbd> para cambiar</p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title">Para despertar renovado a las <span id="wake-up-time"></span>, intenta dormirte a una de estas horas: <small style="font-weight: normal;">(Incluye 15 minutos para conciliar el sueño y ciclos de sueño de 90 minutos)</small></h3>
        ...
        <div style="background-color: #1c2b3a; border-left: 5px solid #00c7b4; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: left;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> Consejo de la British Heart Foundation: <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(leer más)</a></p>
          <ul style="margin: 0; padding-left: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Duerma entre las <strong>10pm-11pm</strong> para un corazón más sano.
            </li>
            <li style="padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              La mayoría de los adultos deben aspirar a dormir de <strong>7 a 9 horas</strong> por noche.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>¿Ir a la cama ahora?</h3>
        <a href="/es/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">Prueba nuestra Calculadora de Hora de Despertar</a>
    </div>
</div>
...
<script>
    ...
    function createScroller(containerId, items, prevScrollerId, nextScrollerId) {
        ...
        container.addEventListener('wheel', e => {
            ...
            realTranslateY -= e.deltaY * 0.5; // Ajustar sensibilidad
        ...
        // Soporte para teclado y clic
        container.tabIndex = 0; // Hacer enfocable
        container.style.outline = 'none'; // Eliminar contorno predeterminado

        container.addEventListener('focus', () => {
            selection.style.borderColor = '#ffc107'; // Resaltar al enfocar
        });
        container.addEventListener('blur', () => {
            selection.style.borderColor = '#00c7b4'; // Revertir al desenfocar
        });
    ...
    function calculateBedtimes() {
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} de sueño)`;
