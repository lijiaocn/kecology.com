---
layout: page
title: "حاسبة وقت النوم: ما هو الوقت الذي يجب أن أذهب فيه إلى الفراش لأشعر بالانتعاش؟"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: ar
permalink: /ar/tool/best-bedtime-calculator
description: "ابحث عن أفضل وقت للنوم بناءً على دورات نوم مدتها 90 دقيقة. يمكن أن يساعدك ذلك على الاستيقاظ وأنت تشعر بالانتعاش والنشاط."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container" dir="rtl">
    <h1>حاسبة وقت النوم</h1>
    <p>حدد وقت استيقاظك لتعرف متى يجب أن تذهب إلى النوم.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">اختصارات: <kbd>↑</kbd> <kbd>↓</kbd> للتعديل، و <kbd>←</kbd> <kbd>→</kbd> للتبديل</p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title">للاستيقاظ منتعشًا في <span id="wake-up-time"></span>، حاول أن تغفو في أحد هذه الأوقات: <small style="font-weight: normal;">(تشمل 15 دقيقة للغفو ودورات نوم مدتها 90 دقيقة)</small></h3>
        <div id="bedtime-options"></div>
        <div style="background-color: #1c2b3a; border-right: 5px solid #00c7b4; border-left: 0; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: right;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> نصيحة مؤسسة القلب البريطانية: <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(اقرأ المزيد)</a></p>
          <ul style="margin: 0; padding-right: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-right: 20px; position: relative;">
              <span style="position: absolute; right: 0; color: #00c7b4;">✔</span>
              نم بين <strong>10 مساءً - 11 مساءً</strong> لقلب أكثر صحة.
            </li>
            <li style="padding-right: 20px; position: relative;">
              <span style="position: absolute; right: 0; color: #00c7b4;">✔</span>
              يجب أن يهدف معظم البالغين إلى النوم من <strong>7 إلى 9 ساعات</strong> كل ليلة.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>هل تريد الذهاب إلى الفراش الآن؟</h3>
        <a href="/ar/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">جرب حاسبة وقت الاستيقاظ</a>
    </div>
</div>
...
<script>
    ...
    function calculateBedtimes() {
        ...
        if (ampmVal === 'م' && hour < 12) {
            hour += 12;
        }
        if (ampmVal === 'ص' && hour === 12) {
            hour = 0;
        }
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} نوم)`;
    ...
    function setInitialTime() {
        ...
        const initialAmpm = initialHour >= 12 ? 'م' : 'ص';
