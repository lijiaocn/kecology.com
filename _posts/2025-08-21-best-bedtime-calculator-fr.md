---
layout: page
title: "Calculateur d'heure de coucher : À quelle heure dois-je me coucher pour me sentir reposé ?"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: fr
permalink: /fr/tool/best-bedtime-calculator
description: "Trouvez la meilleure heure pour vous endormir en fonction de cycles de sommeil de 90 minutes. Cela peut vous aider à vous réveiller en vous sentant reposé et plein d'énergie."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container">
    <h1>Calculateur d'heure de coucher</h1>
    <p>Réglez votre heure de réveil pour voir quand vous devriez vous coucher.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">Raccourcis : <kbd>↑</kbd> <kbd>↓</kbd> pour ajuster, et <kbd>←</kbd> <kbd>→</kbd> pour changer</p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title">Pour vous réveiller reposé à <span id="wake-up-time"></span>, essayez de vous endormir à l'une de ces heures : <small style="font-weight: normal;">(Comprend 15 minutes pour s'endormir et des cycles de sommeil de 90 minutes)</small></h3>
        ...
        <div style="background-color: #1c2b3a; border-left: 5px solid #00c7b4; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: left;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> Conseil de la British Heart Foundation : <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(en savoir plus)</a></p>
          <ul style="margin: 0; padding-left: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Dormez entre <strong>22h et 23h</strong> pour un cœur en meilleure santé.
            </li>
            <li style="padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              La plupart des adultes devraient viser <strong>7 à 9 heures</strong> de sommeil par nuit.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>Se coucher maintenant ?</h3>
        <a href="/fr/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">Essayez notre Calculateur d'heure de réveil</a>
    </div>
</div>
...
<script>
    ...
    function createScroller(containerId, items, prevScrollerId, nextScrollerId) {
        ...
        container.addEventListener('wheel', e => {
            ...
            realTranslateY -= e.deltaY * 0.5; // Ajuster la sensibilité
        ...
        // Prise en charge du clavier et du clic
        container.tabIndex = 0; // Rendre focusable
        container.style.outline = 'none'; // Supprimer le contour par défaut

        container.addEventListener('focus', () => {
            selection.style.borderColor = '#ffc107'; // Surligner lors du focus
        });
        container.addEventListener('blur', () => {
            selection.style.borderColor = '#00c7b4'; // Rétablir lors de la perte de focus
        });
    ...
    function calculateBedtimes() {
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} de sommeil)`;
