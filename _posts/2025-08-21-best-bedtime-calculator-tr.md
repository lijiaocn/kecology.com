---
layout: page
title: "Yatma Zamanı Hesaplayıcı: Dinlenmiş Hissetmek İçin Ne Zaman Yatmalıyım?"
date:   2025-08-15 17:25:46 +0800
last_modified_at: 2025-09-09 14:59:00 +0800
categories: tool
lang: tr
permalink: /tr/tool/best-bedtime-calculator
description: "90 dakikalık uyku döngülerine göre uyumak için en iyi zamanı bulun. Yenilenmiş ve enerjik hissederek uyanmanıza yardımcı olabilir."
mysetting:
  nowrapper: false
---
...
<div id="sleep-calculator-container">
    <h1>Yatma Zamanı Hesaplayıcı</h1>
    <p>Ne zaman uyumanız gerektiğini görmek için uyanma saatinizi ayarlayın.</p>
    <div id="controls">
    ...
    <p class="keyboard-hint">Kısayollar: Ayarlamak için <kbd>↑</kbd> <kbd>↓</kbd> ve geçiş yapmak için <kbd>←</kbd> <kbd>→</kbd></p>
    <div id="results-container" style="display: none;">
        <h3 id="results-title"><span id="wake-up-time"></span>'de dinlenmiş uyanmak için şu saatlerden birinde uyumaya çalışın: <small style="font-weight: normal;">(15 dakika uykuya dalma süresi ve 90 dakikalık uyku döngüleri içerir)</small></h3>
        ...
        <div style="background-color: #1c2b3a; border-left: 5px solid #00c7b4; padding: 15px; margin: 20px 0 0 0; border-radius: 4px; color: #e0e0e0; font-size: 15px; text-align: left;">
          <p style="margin: 0 0 10px 0; font-weight: bold;"><span style="color: #ff6b6b;">❤</span> İngiliz Kalp Vakfı Tavsiyesi: <a href="https://www.bhf.org.uk/informationsupport/heart-matters-magazine/news/behind-the-headlines/sleep-time-and-heart-disease" target="_blank" style="color: #8492a6; text-decoration: none; font-size: 12px;">(daha fazla bilgi)</a></p>
          <ul style="margin: 0; padding-left: 0; list-style-type: none;">
            <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Daha sağlıklı bir kalp için <strong>22:00-23:00</strong> arasında uyuyun.
            </li>
            <li style="padding-left: 20px; position: relative;">
              <span style="position: absolute; left: 0; color: #00c7b4;">✔</span>
              Çoğu yetişkin gece başına <strong>7 ila 9 saat</strong> uyumayı hedeflemelidir.
            </li>
          </ul>
        </div>
    </div>
    ...
    <div id="suggestion-now">
        <h3>Şimdi mi yatsan?</h3>
        <a href="/tr/tool/wakeup-calculator" class="bedtime-option-btn" style="text-decoration: none;">Uyanma Zamanı Hesaplayıcımızı Deneyin</a>
    </div>
</div>
...
<script>
    ...
    function createScroller(containerId, items, prevScrollerId, nextScrollerId) {
        ...
        container.addEventListener('wheel', e => {
            ...
            realTranslateY -= e.deltaY * 0.5; // Hassasiyeti ayarla
        ...
        // Klavye ve Tıklama desteği
        container.tabIndex = 0; // Odaklanılabilir yap
        container.style.outline = 'none'; // Varsayılan dış çizgiyi kaldır

        container.addEventListener('focus', () => {
            selection.style.borderColor = '#ffc107'; // Odaklandığında vurgula
        });
        container.addEventListener('blur', () => {
            selection.style.borderColor = '#00c7b4'; // Bulanıklaştığında geri al
        });
    ...
    function calculateBedtimes() {
        ...
        if (ampmVal === 'ÖS' && hour < 12) {
            hour += 12;
        }
        if (ampmVal === 'ÖÖ' && hour === 12) {
            hour = 0;
        }
        ...
        bedtimes.forEach(bt => {
            ...
            durationSpan.textContent = `(${bt.duration} uyku)`;
    ...
    function setInitialTime() {
        ...
        const initialAmpm = initialHour >= 12 ? 'ÖS' : 'ÖÖ';
