document.addEventListener('DOMContentLoaded', () => {
    ...
    const countryTimeInfo = {
        'USA': { description: 'تستخدم الولايات المتحدة 4 مناطق زمنية: <strong>التوقيت الشرقي (EST/EDT)</strong>، <strong>التوقيت المركزي (CST/CDT)</strong>، <strong>التوقيت الجبلي (MST/MDT)</strong>، و <strong>توقيت المحيط الهادئ (PST/PDT)</strong>. يتم العمل بالتوقيت الصيفي.' },
        'Canada': { description: 'تستخدم كندا منطقة زمنية واحدة: <strong>التوقيت الشرقي (EST/EDT)</strong> وتعمل بالتوقيت الصيفي.' },
        'Brazil': { description: 'تستخدم البرازيل منطقة زمنية واحدة: <strong>توقيت برازيليا (BRT)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'UK': { description: 'تستخدم المملكة المتحدة منطقة زمنية واحدة: <strong>توقيت غرينتش (GMT)</strong> و <strong>التوقيت الصيفي البريطاني (BST)</strong>، مع مراعاة التوقيت الصيفي.' },
        'France': { description: 'تستخدم فرنسا منطقة زمنية واحدة: <strong>توقيت وسط أوروبا (CET)</strong> و <strong>توقيت وسط أوروبا الصيفي (CEST)</strong>، مع مراعاة التوقيت الصيفي.' },
        'Germany': { description: 'تستخدم ألمانيا منطقة زمنية واحدة: <strong>توقيت وسط أوروبا (CET)</strong> و <strong>توقيت وسط أوروبا الصيفي (CEST)</strong>، مع مراعاة التوقيت الصيفي.' },
        'Russia': { description: 'تستخدم روسيا منطقة زمنية واحدة: <strong>توقيت موسكو الرسمي (MSK)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'Egypt': { description: 'تستخدم مصر منطقة زمنية واحدة: <strong>توقيت شرق أوروبا (EET)</strong> و <strong>توقيت شرق أوروبا الصيفي (EEST)</strong>، مع مراعاة التوقيت الصيفي.' },
        'South Africa': { description: 'تستخدم جنوب إفريقيا منطقة زمنية واحدة: <strong>توقيت جنوب إفريقيا الرسمي (SAST)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'UAE': { description: 'تستخدم الإمارات العربية المتحدة منطقة زمنية واحدة: <strong>توقيت الخليج الرسمي (GST)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'India': { description: 'تستخدم الهند منطقة زمنية واحدة: <strong>التوقيت الهندي الرسمي (IST)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'Singapore': { description: 'تستخدم سنغافورة منطقة زمنية واحدة: <strong>توقيت سنغافورة الرسمي (SGT)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'China': { description: 'تستخدم الصين منطقة زمنية واحدة: <strong>توقيت الصين الرسمي (CST)</strong> ولا تعمل بالتوقيت الصيفي. تستخدم الدولة بأكملها توقيت بكين.' },
        'South Korea': { description: 'تستخدم كوريا الجنوبية منطقة زمنية واحدة: <strong>توقيت كوريا الرسمي (KST)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'Japan': { description: 'تستخدم اليابان منطقة زمنية واحدة: <strong>توقيت اليابان الرسمي (JST)</strong> ولا تعمل بالتوقيت الصيفي.' },
        'Australia': { description: 'تستخدم أستراليا منطقة زمنية واحدة: <strong>التوقيت الرسمي لشرق أستراليا (AEST)</strong> و <strong>التوقيت الصيفي لشرق أستراليا (AEDT)</strong>، مع مراعاة التوقيت الصيفي.' },
        'New Zealand': { description: 'تستخدم نيوزيلندا منطقة زمنية واحدة: <strong>توقيت نيوزيلندا الرسمي (NZST)</strong> و <strong>التوقيت الصيفي لنيوزيلندا (NZDT)</strong>، مع مراعاة التوقيت الصيفي.' }
    };
    ...
    function getLocalCityName(timezone) {
        const timezoneMap = {
            'America/New_York': 'نيويورك', 'America/Chicago': 'شيكاغو', 'America/Denver': 'دنفر', 'America/Los_Angeles': 'لوس أنجلوس', 'Europe/London': 'لندن', 'Europe/Paris': 'باريس', 'Europe/Berlin': 'برلين', 'Asia/Tokyo': 'طوكيو', 'Asia/Shanghai': 'شنغهاي', 'Asia/Hong_Kong': 'هونغ كونغ', 'Asia/Singapore': 'سنغافورة', 'Australia/Sydney': 'سيدني', 'Australia/Melbourne': 'ملبورن', 'Pacific/Auckland': 'أوكلاند', 'America/Toronto': 'تورنتو', 'America/Vancouver': 'فانكوفر', 'Europe/Madrid': 'مدريد', 'Europe/Rome': 'روما', 'Asia/Seoul': 'سيول', 'Asia/Mumbai': 'مومباي', 'America/Sao_Paulo': 'ساو باولو', 'America/Mexico_City': 'مكسيكو سيتي', 'Africa/Cairo': 'القاهرة', 'Africa/Johannesburg': 'جوهانسبرغ'
        };
    ...
    function renderDateButtons() {
        ...
        for (let i = 0; i < buttonCount; i++) {
            ...
            const weekday = date.toLocaleDateString('ar-EG', { weekday: 'short' });
    ...
    function handleRowsMouseMove(percent, selectorLeft) {
        ...
        rows.forEach(row => {
            ...
            const timeFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, hour: 'numeric', minute: 'numeric', hour12: false });
    ...
    function loadCityOrder() {
        try {
            ...
            console.warn('فشل تحميل ترتيب المدينة:', e);
        }
        return null;
    }
    ...
    function updateSingleRowTimeDisplay(row) {
        ...
        try {
            const timeFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, hour: 'numeric', minute: 'numeric', hour12: false });
            const dateFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, weekday: 'short', month: 'short', day: 'numeric' });
            const timeString = timeFormatter.format(now);
            const dateString = dateFormatter.format(now);
            const timeElement = row.querySelector('.wtp-current-time');
            timeElement.title = 'الوقت المحلي الحالي';
            timeElement.innerHTML = `${timeString}<br><span style="font-size: 0.8em; color: #aaa;">${dateString}</span>`;
        } catch (error) {
            console.warn(`تعذر تنسيق الوقت للمنطقة الزمنية ${timezone}:`, error);
            const timeElement = row.querySelector('.wtp-current-time');
            timeElement.title = 'منطقة زمنية غير صالحة';
            timeElement.innerHTML = `غير صالح<br><span style="font-size: 0.8em; color: #aaa;">منطقة زمنية</span>`;
        }
    }
    ...
    function renderTimelineGrid(row) {
        ...
        const hourFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, hour: 'numeric', hour12: false });
        const fullDateFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, year: 'numeric', month: 'numeric', day: 'numeric' });
        const weekdayFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, weekday: 'short' });
        const ymdPartsFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, year: 'numeric', month: '2-digit', day: '2-digit' });
        const now = new Date();
        ...
        for (let i = 0; i < TIMELINE_HOURS; i++) {
            ...
            if (weekdayShort === 'السبت' || weekdayShort === 'الأحد') {
            ...
            if (dateOfThisBlock === currentDateInTimezone && localHour === currentHourInTimezone) {
                ...
                currentTimeIndicator.textContent = 'الآن';
            ...
            if (hourCount >= 2) {
                ...
                if (hourBlocks.length > 0) {
                    ...
                    if (startIndex >= 0) {
                        ...
                        const timezone = row.dataset.timezone;
                        const timezoneWeekdayFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, weekday: 'short' });
                        const timezoneDateFormatter = new Intl.DateTimeFormat('ar-EG', { timeZone: timezone, year: 'numeric', month: 'numeric', day: 'numeric' });
    ...
    function createMobileRangeOverlay(startPercent, endPercent) {
        ...
        button.textContent = 'عرض الأوقات';
    ...
    function updateRangeInfo(timeRange) {
        ...
        document.getElementById('wtp-duration-display').textContent = `${durationHours}س ${durationMinutes}د`;
    }
    ...
    function updateTimezoneTimesDisplay(timezoneTimesData) {
        ...
        timezoneTimesData.forEach(data => {
            ...
            const startFormatted = start.toLocaleTimeString('ar-EG', { hour: '2-digit', minute: '2-digit' });
            const endFormatted = end.toLocaleTimeString('ar-EG', { hour: '2-digit', minute: '2-digit' });
            const startDateFormatted = start.toLocaleDateString('ar-EG', { weekday: 'short', month: 'short', day: 'numeric' });
    ...
    document.getElementById('wtp-google-meeting-btn').addEventListener('click', () => {
        ...
        const title = 'اجتماع مجدول';
        const details = 'تفاصيل الاجتماع';
    ...
    document.getElementById('wtp-outlook-meeting-btn').addEventListener('click', () => {
        ...
        const { start, end } = currentTimeRange;
        const title = 'اجتماع مجدول';
        const url = `https://outlook.live.com/calendar/0/deeplink/compose?subject=${encodeURIComponent(title)}&startdt=${start.toISOString()}&enddt=${end.toISOString()}&body=${encodeURIComponent('تفاصيل الاجتماع')}`;
        window.open(url, '_blank');
    });
