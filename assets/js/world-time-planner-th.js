document.addEventListener('DOMContentLoaded', () => {
    ...
    const countryTimeInfo = {
        'USA': { description: 'สหรัฐอเมริกาใช้ 4 เขตเวลา: <strong>เวลาตะวันออก (EST/EDT)</strong>, <strong>เวลากลาง (CST/CDT)</strong>, <strong>เวลาภูเขา (MST/MDT)</strong>, และ <strong>เวลาแปซิฟิก (PST/PDT)</strong>. สังเกตเวลาออมแสง' },
        'Canada': { description: 'แคนาดาใช้ 1 เขตเวลา: <strong>เวลาตะวันออก (EST/EDT)</strong> และสังเกตเวลาออมแสง' },
        'Brazil': { description: 'บราซิลใช้ 1 เขตเวลา: <strong>เวลาบราซิเลีย (BRT)</strong> และไม่สังเกตเวลาออมแสง' },
        'UK': { description: 'สหราชอาณาจักรใช้ 1 เขตเวลา: <strong>เวลามาตรฐานกรีนิช (GMT)</strong> และ <strong>เวลาฤดูร้อนของอังกฤษ (BST)</strong>, สังเกตเวลาออมแสง' },
        'France': { description: 'ฝรั่งเศสใช้ 1 เขตเวลา: <strong>เวลายุโรปกลาง (CET)</strong> และ <strong>เวลาฤดูร้อนยุโรปกลาง (CEST)</strong>, สังเกตเวลาออมแสง' },
        'Germany': { description: 'เยอรมนีใช้ 1 เขตเวลา: <strong>เวลายุโรปกลาง (CET)</strong> และ <strong>เวลาฤดูร้อนยุโรปกลาง (CEST)</strong>, สังเกตเวลาออมแสง' },
        'Russia': { description: 'รัสเซียใช้ 1 เขตเวลา: <strong>เวลามาตรฐานมอสโก (MSK)</strong> และไม่สังเกตเวลาออมแสง' },
        'Egypt': { description: 'อียิปต์ใช้ 1 เขตเวลา: <strong>เวลาตะวันออกยุโรป (EET)</strong> และ <strong>เวลาฤดูร้อนตะวันออกยุโรป (EEST)</strong>, สังเกตเวลาออมแสง' },
        'South Africa': { description: 'แอฟริกาใต้ใช้ 1 เขตเวลา: <strong>เวลามาตรฐานแอฟริกาใต้ (SAST)</strong> และไม่สังเกตเวลาออมแสง' },
        'UAE': { description: 'สหรัฐอาหรับเอมิเรตส์ใช้ 1 เขตเวลา: <strong>เวลามาตรฐานอ่าว (GST)</strong> และไม่สังเกตเวลาออมแสง' },
        'India': { description: 'อินเดียใช้ 1 เขตเวลา: <strong>เวลามาตรฐานอินเดีย (IST)</strong> และไม่สังเกตเวลาออมแสง' },
        'Singapore': { description: 'สิงคโปร์ใช้ 1 เขตเวลา: <strong>เวลามาตรฐานสิงคโปร์ (SGT)</strong> และไม่สังเกตเวลาออมแสง' },
        'China': { description: 'จีนใช้ 1 เขตเวลา: <strong>เวลามาตรฐานจีน (CST)</strong> และไม่สังเกตเวลาออมแสง ทั้งประเทศใช้เวลาปักกิ่ง' },
        'South Korea': { description: 'เกาหลีใต้ใช้ 1 เขตเวลา: <strong>เวลามาตรฐานเกาหลี (KST)</strong> และไม่สังเกตเวลาออมแสง' },
        'Japan': { description: 'ญี่ปุ่นใช้ 1 เขตเวลา: <strong>เวลามาตรฐานญี่ปุ่น (JST)</strong> และไม่สังเกตเวลาออมแสง' },
        'Australia': { description: 'ออสเตรเลียใช้ 1 เขตเวลา: <strong>เวลามาตรฐานตะวันออกของออสเตรเลีย (AEST)</strong> และ <strong>เวลาออมแสงตะวันออกของออสเตรเลีย (AEDT)</strong>, สังเกตเวลาออมแสง' },
        'New Zealand': { description: 'นิวซีแลนด์ใช้ 1 เขตเวลา: <strong>เวลามาตรฐานนิวซีแลนด์ (NZST)</strong> และ <strong>เวลาออมแสงนิวซีแลนด์ (NZDT)</strong>, สังเกตเวลาออมแสง' }
    };
    ...
    function getLocalCityName(timezone) {
        const timezoneMap = {
            'America/New_York': 'นิวยอร์ก', 'America/Chicago': 'ชิคาโก', 'America/Denver': 'เดนเวอร์', 'America/Los_Angeles': 'ลอสแอนเจลิส', 'Europe/London': 'ลอนดอน', 'Europe/Paris': 'ปารีส', 'Europe/Berlin': 'เบอร์ลิน', 'Asia/Tokyo': 'โตเกียว', 'Asia/Shanghai': 'เซี่ยงไฮ้', 'Asia/Hong_Kong': 'ฮ่องกง', 'Asia/Singapore': 'สิงคโปร์', 'Australia/Sydney': 'ซิดนีย์', 'Australia/Melbourne': 'เมลเบิร์น', 'Pacific/Auckland': 'โอ๊คแลนด์', 'America/Toronto': 'โทรอนโต', 'America/Vancouver': 'แวนคูเวอร์', 'Europe/Madrid': 'มาดริด', 'Europe/Rome': 'โรม', 'Asia/Seoul': 'โซล', 'Asia/Mumbai': 'มุมไบ', 'America/Sao_Paulo': 'เซาเปาลู', 'America/Mexico_City': 'เม็กซิโกซิตี้', 'Africa/Cairo': 'ไคโร', 'Africa/Johannesburg': 'โจฮันเนสเบิร์ก'
        };
    ...
    function handleRowsMouseMove(percent, selectorLeft) {
        ...
        rows.forEach(row => {
            ...
            const timeFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, hour: 'numeric', minute: 'numeric', hour12: false });
    ...
    function loadCityOrder() {
        try {
            ...
            console.warn('ไม่สามารถโหลดลำดับเมืองได้:', e);
        }
        return null;
    }
    ...
    function updateSingleRowTimeDisplay(row) {
        ...
        try {
            const timeFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, hour: 'numeric', minute: 'numeric', hour12: false });
            const dateFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, weekday: 'short', month: 'short', day: 'numeric' });
            const timeString = timeFormatter.format(now);
            const dateString = dateFormatter.format(now);
            const timeElement = row.querySelector('.wtp-current-time');
            timeElement.title = 'เวลาท้องถิ่นปัจจุบัน';
            timeElement.innerHTML = `${timeString}<br><span style="font-size: 0.8em; color: #aaa;">${dateString}</span>`;
        } catch (error) {
            console.warn(`ไม่สามารถจัดรูปแบบเวลาสำหรับเขตเวลา ${timezone}:`, error);
            const timeElement = row.querySelector('.wtp-current-time');
            timeElement.title = 'เขตเวลาไม่ถูกต้อง';
            timeElement.innerHTML = `ไม่ถูกต้อง<br><span style="font-size: 0.8em; color: #aaa;">เขตเวลา</span>`;
        }
    }
    ...
    function renderTimelineGrid(row) {
        ...
        const hourFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, hour: 'numeric', hour12: false });
        const fullDateFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, year: 'numeric', month: 'numeric', day: 'numeric' });
        const weekdayFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, weekday: 'short' });
        const ymdPartsFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, year: 'numeric', month: '2-digit', day: '2-digit' });
        const now = new Date();
        ...
        for (let i = 0; i < TIMELINE_HOURS; i++) {
            ...
            if (weekdayShort === 'ส.' || weekdayShort === 'อา.') {
            ...
            if (dateOfThisBlock === currentDateInTimezone && localHour === currentHourInTimezone) {
                ...
                currentTimeIndicator.textContent = 'ตอนนี้';
            ...
            if (hourCount >= 2) {
                ...
                if (hourBlocks.length > 0) {
                    ...
                    if (startIndex >= 0) {
                        ...
                        const timezone = row.dataset.timezone;
                        const timezoneWeekdayFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, weekday: 'short' });
                        const timezoneDateFormatter = new Intl.DateTimeFormat('th-TH', { timeZone: timezone, year: 'numeric', month: 'numeric', day: 'numeric' });
    ...
    function updateRangeInfo(timeRange) {
        ...
        document.getElementById('wtp-duration-display').textContent = `${durationHours}ชม. ${durationMinutes}น.`;
    }
    ...
    function updateTimezoneTimesDisplay(timezoneTimesData) {
        ...
        timezoneTimesData.forEach(data => {
            ...
            const startFormatted = start.toLocaleTimeString('th-TH', { hour: '2-digit', minute: '2-digit' });
            const endFormatted = end.toLocaleTimeString('th-TH', { hour: '2-digit', minute: '2-digit' });
            const startDateFormatted = start.toLocaleDateString('th-TH', { weekday: 'short', month: 'short', day: 'numeric' });
    ...
    document.getElementById('wtp-google-meeting-btn').addEventListener('click', () => {
        ...
        const title = 'การประชุมที่กำหนดเวลาไว้';
        const details = 'รายละเอียดการประชุม';
    ...
    document.getElementById('wtp-outlook-meeting-btn').addEventListener('click', () => {
        ...
        const { start, end } = currentTimeRange;
        const title = 'การประชุมที่กำหนดเวลาไว้';
        const url = `https://outlook.live.com/calendar/0/deeplink/compose?subject=${encodeURIComponent(title)}&startdt=${start.toISOString()}&enddt=${end.toISOString()}&body=${encodeURIComponent('รายละเอียดการประชุม')}`;
        window.open(url, '_blank');
    });
