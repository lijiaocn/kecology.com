document.addEventListener('DOMContentLoaded', () => {
    ...
    const countryTimeInfo = {
        'USA': { description: 'संयुक्त राज्य अमेरिका 4 समय क्षेत्रों का उपयोग करता है: <strong>पूर्वी समय (EST/EDT)</strong>, <strong>मध्य समय (CST/CDT)</strong>, <strong>पहाड़ी समय (MST/MDT)</strong>, और <strong>प्रशांत समय (PST/PDT)</strong>। डेलाइट सेविंग टाइम का पालन करता है।' },
        'Canada': { description: 'कनाडा 1 समय क्षेत्र का उपयोग करता है: <strong>पूर्वी समय (EST/EDT)</strong> और डेलाइट सेविंग टाइम का पालन करता है।' },
        'Brazil': { description: 'ब्राजील 1 समय क्षेत्र का उपयोग करता है: <strong>ब्रासीलिया समय (BRT)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'UK': { description: 'यूनाइटेड किंगडम 1 समय क्षेत्र का उपयोग करता है: <strong>ग्रीनविच मीन टाइम (GMT)</strong> और <strong>ब्रिटिश समर टाइम (BST)</strong>, डेलाइट सेविंग टाइम का पालन करता है।' },
        'France': { description: 'फ्रांस 1 समय क्षेत्र का उपयोग करता है: <strong>मध्य यूरोपीय समय (CET)</strong> और <strong>मध्य यूरोपीय ग्रीष्मकालीन समय (CEST)</strong>, डेलाइट सेविंग टाइम का पालन करता है।' },
        'Germany': { description: 'जर्मनी 1 समय क्षेत्र का उपयोग करता है: <strong>मध्य यूरोपीय समय (CET)</strong> और <strong>मध्य यूरोपीय ग्रीष्मकालीन समय (CEST)</strong>, डेलाइट सेविंग टाइम का पालन करता है।' },
        'Russia': { description: 'रूस 1 समय क्षेत्र का उपयोग करता है: <strong>मास्को मानक समय (MSK)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'Egypt': { description: 'मिस्र 1 समय क्षेत्र का उपयोग करता है: <strong>पूर्वी यूरोपीय समय (EET)</strong> और <strong>पूर्वी यूरोपीय ग्रीष्मकालीन समय (EEST)</strong>, डेलाइट सेविंग टाइम का पालन करता है।' },
        'South Africa': { description: 'दक्षिण अफ्रीका 1 समय क्षेत्र का उपयोग करता है: <strong>दक्षिण अफ्रीकी मानक समय (SAST)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'UAE': { description: 'यूएई 1 समय क्षेत्र का उपयोग करता है: <strong>खाड़ी मानक समय (GST)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'India': { description: 'भारत 1 समय क्षेत्र का उपयोग करता है: <strong>भारतीय मानक समय (IST)</strong> और डेलाइट सेवING टाइम का पालन नहीं करता है।' },
        'Singapore': { description: 'सिंगापुर 1 समय क्षेत्र का उपयोग करता है: <strong>सिंगापुर मानक समय (SGT)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'China': { description: 'चीन 1 समय क्षेत्र का उपयोग करता है: <strong>चीन मानक समय (CST)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है। पूरा देश बीजिंग समय का उपयोग करता है।' },
        'South Korea': { description: 'दक्षिण कोरिया 1 समय क्षेत्र का उपयोग करता है: <strong>कोरिया मानक समय (KST)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'Japan': { description: 'जापान 1 समय क्षेत्र का उपयोग करता है: <strong>जापान मानक समय (JST)</strong> और डेलाइट सेविंग टाइम का पालन नहीं करता है।' },
        'Australia': { description: 'ऑस्ट्रेलिया 1 समय क्षेत्र का उपयोग करता है: <strong>ऑस्ट्रेलियाई पूर्वी मानक समय (AEST)</strong> और <strong>ऑस्ट्रेलियाई पूर्वी डेलाइट समय (AEDT)</strong>, डेलाइट सेविंग टाइम का पालन करता है।' },
        'New Zealand': { description: 'न्यूजीलैंड 1 समय क्षेत्र का उपयोग करता है: <strong>न्यूजीलैंड मानक समय (NZST)</strong> और <strong>न्यूजीलैंड डेलाइट समय (NZDT)</strong>, डेलाइट सेविंग टाइम का पालन करता है।' }
    };
    ...
    function getLocalCityName(timezone) {
        const timezoneMap = {
            'America/New_York': 'न्यूयॉर्क', 'America/Chicago': 'शिकागो', 'America/Denver': 'डेनवर', 'America/Los_Angeles': 'लॉस एंजिल्स', 'Europe/London': 'लंदन', 'Europe/Paris': 'पेरिस', 'Europe/Berlin': 'बर्लिन', 'Asia/Tokyo': 'टोक्यो', 'Asia/Shanghai': 'शंघाई', 'Asia/Hong_Kong': 'हांगकांग', 'Asia/Singapore': 'सिंगापुर', 'Australia/Sydney': 'सिडनी', 'Australia/Melbourne': 'मेलबर्न', 'Pacific/Auckland': 'ऑकलैंड', 'America/Toronto': 'टोरंटो', 'America/Vancouver': 'वैंकूवर', 'Europe/Madrid': 'मैड्रिड', 'Europe/Rome': 'रोम', 'Asia/Seoul': 'सियोल', 'Asia/Mumbai': 'मुंबई', 'America/Sao_Paulo': 'साओ पाउलो', 'America/Mexico_City': 'मेक्सिको सिटी', 'Africa/Cairo': 'काहिरा', 'Africa/Johannesburg': 'जोहान्सबर्ग'
        };
    ...
    function handleRowsMouseMove(percent, selectorLeft) {
        ...
        rows.forEach(row => {
            ...
            const timeFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, hour: 'numeric', minute: 'numeric', hour12: false });
    ...
    function loadCityOrder() {
        try {
            ...
            console.warn('शहर क्रम लोड करने में विफल:', e);
        }
        return null;
    }
    ...
    function updateSingleRowTimeDisplay(row) {
        ...
        try {
            const timeFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, hour: 'numeric', minute: 'numeric', hour12: false });
            const dateFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, weekday: 'short', month: 'short', day: 'numeric' });
            const timeString = timeFormatter.format(now);
            const dateString = dateFormatter.format(now);
            const timeElement = row.querySelector('.wtp-current-time');
            timeElement.title = 'वर्तमान स्थानीय समय';
            timeElement.innerHTML = `${timeString}<br><span style="font-size: 0.8em; color: #aaa;">${dateString}</span>`;
        } catch (error) {
            console.warn(`समय क्षेत्र ${timezone} के लिए समय प्रारूपित करने में विफल:`, error);
            const timeElement = row.querySelector('.wtp-current-time');
            timeElement.title = 'अमान्य समय क्षेत्र';
            timeElement.innerHTML = `अमान्य<br><span style="font-size: 0.8em; color: #aaa;">समय क्षेत्र</span>`;
        }
    }
    ...
    function renderTimelineGrid(row) {
        ...
        const hourFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, hour: 'numeric', hour12: false });
        const fullDateFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, year: 'numeric', month: 'numeric', day: 'numeric' });
        const weekdayFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, weekday: 'short' });
        const ymdPartsFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, year: 'numeric', month: '2-digit', day: '2-digit' });
        const now = new Date();
        ...
        for (let i = 0; i < TIMELINE_HOURS; i++) {
            ...
            if (weekdayShort === 'शनि' || weekdayShort === 'रवि') {
            ...
            if (dateOfThisBlock === currentDateInTimezone && localHour === currentHourInTimezone) {
                ...
                currentTimeIndicator.textContent = 'अभी';
            ...
            if (hourCount >= 2) {
                ...
                if (hourBlocks.length > 0) {
                    ...
                    if (startIndex >= 0) {
                        ...
                        const timezone = row.dataset.timezone;
                        const timezoneWeekdayFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, weekday: 'short' });
                        const timezoneDateFormatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, year: 'numeric', month: 'numeric', day: 'numeric' });
    ...
    function calculateTimezoneTimes(timeRange) {
        ...
        timelineRows.forEach(row => {
            ...
            const cityName = cityElement ? cityElement.textContent : 'अज्ञात';
            if (timezone) {
                ...
                times.push({ city: cityName, timezone: timezone, start: startTimeInTimezone, end: endTimeInTimezone });
            }
        });
        return times;
    }
    ...
    function formatTimeInTimezone(date, timezone) {
        try {
            const formatter = new Intl.DateTimeFormat('hi-IN', { timeZone: timezone, year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: false });
            return formatter.format(date);
        } catch (error) {
            console.warn(`समय क्षेत्र ${timezone} के लिए समय प्रारूपित करने में विफल:`, error);
            return 'अमान्य समय क्षेत्र';
        }
    }
    ...
    function updateRangeInfo(timeRange) {
        ...
        document.getElementById('wtp-duration-display').textContent = `${durationHours}घं ${durationMinutes}मि`;
    }
    ...
    function updateTimezoneTimesDisplay(timezoneTimesData) {
        ...
        timezoneTimesData.forEach(data => {
            ...
            const startFormatted = start.toLocaleTimeString('hi-IN', { hour: '2-digit', minute: '2-digit' });
            const endFormatted = end.toLocaleTimeString('hi-IN', { hour: '2-digit', minute: '2-digit' });
            const startDateFormatted = start.toLocaleDateString('hi-IN', { weekday: 'short', month: 'short', day: 'numeric' });
    ...
    document.getElementById('wtp-google-meeting-btn').addEventListener('click', () => {
        ...
        const title = 'नियोजित बैठक';
        const details = 'बैठक का विवरण';
        const url = `https://www.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(title)}&dates=${start.toISOString().replace(/-|:|	erweight+/g, '')}/${end.toISOString().replace(/-|:|	erweight+/g, '')}&details=${encodeURIComponent(details)}`;
    ...
    document.getElementById('wtp-outlook-meeting-btn').addEventListener('click', () => {
        ...
        const { start, end } = currentTimeRange;
        const title = 'नियोजित बैठक';
        const url = `https://outlook.live.com/calendar/0/deeplink/compose?subject=${encodeURIComponent(title)}&startdt=${start.toISOString()}&enddt=${end.toISOString()}&body=${encodeURIComponent('बैठक का विवरण')}`;
        window.open(url, '_blank');
    });
    ...
    document.getElementById('wtp-yahoo-meeting-btn').addEventListener('click', () => {
        ...
        const url = `https://calendar.yahoo.com/?v=60&view=d&type=20&title=${encodeURIComponent(title)}&st=${start.toISOString().replace(/-|:|	erweight+/g, '')}&dur=${durationHours}${durationMinutes}`;
        window.open(url, '_blank');
    });
