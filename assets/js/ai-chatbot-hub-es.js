...
function addCustomToolCard(toolData) {
  ...
  customCard.innerHTML = `
    ...
    <button class="delete-btn" onclick="deleteCustomTool('${toolData.id}', this)" title="Eliminar herramienta">×</button>
  `;
...
function deleteCustomTool(toolId, buttonElement) {
  if (confirm('¿Estás seguro de que quieres eliminar esta herramienta personalizada?')) {
    let customTools = JSON.parse(localStorage.getItem('ai-chatbot-hub-custom-tools') || '[]');
